...
class Bactery(G_Object):
    ...
    def draw(self):
        self.game.screen.blit( self.sprite, ( self.body.position[0]*self.game.PPM - self.sprite.get_width()/2, (self.game.HEIGHT - self.position[1]) *self.game.PPM- self.sprite.get_height()/2) )
